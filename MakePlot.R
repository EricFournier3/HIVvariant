...
# Diversity, Shannon entropy and Complexity. For each one of these measure one pdf file is created in which one may            #
...
# Rscript MakePlot.R "Complexity Shannon Diversity" "across gp120 region" <StatResults.txt>                                    #
#                                                                                                                              #
################################################################################################################################
...
# <evol_param> is Diversity, Compexity or Shannon                                  #
